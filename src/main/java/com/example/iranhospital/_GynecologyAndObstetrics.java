...
public class _GynecologyAndObstetrics {
    ...
    void BtnEmeregencyMen6(ActionEvent event) {
        if (GlobalState.room.man[6]!=null) {
            lblFirstNameEmergencyMen.setText(GlobalState.room.man[6].getFirstName());
            lblLastNameEmergencyMen.setText(GlobalState.room.man[6].getLastName());
            lblBedNumberEmergencyMen.setText("6");
            lblIDEmergencyMen.setText(String.valueOf(GlobalState.room.man[6].getId()));
        }
    }
    ...
    void BtnEmeregencyWeman6(ActionEvent event) {
        if (GlobalState.room.woman[6]!=null) {
            lblFirstNameEmergencyWeman.setText(GlobalState.room.woman[6].getFirstName());
            lblLastNameEmergencyWeman.setText(GlobalState.room.woman[6].getLastName());
            lblBedNumberEmergencyWeman.setText("6");
            lblIDEmergencyWeman.setText(String.valueOf(GlobalState.room.woman[6].getId()));
        }
    }
